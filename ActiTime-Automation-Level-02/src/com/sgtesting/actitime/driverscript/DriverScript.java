...
public class DriverScript {
	...
	public static void main(String[] args) {
		...
		oBrowser=Initialize.launchBrowser();
				...
				//Create and Modify delete Customer Scenario
				//login-->createCustomer-->modifyCustomer-->deleteCustomer-->logout -->closeApplication
				oBrowser=Initialize.launchBrowser();
				Initialize.navigate(oBrowser);
				LoginLogout.login(oBrowser);
				HomePage.minimizeFlyOutWindow(oBrowser);
				...
				//login-->createCustomer-->CreateProject-->DeleteProject-->deleteCustomer-->logout -->closeApplication
				oBrowser=Initialize.launchBrowser();
				Initialize.navigate(oBrowser);
				LoginLogout.login(oBrowser);
				HomePage.minimizeFlyOutWindow(oBrowser);
				...
				//Create and  delete modifyProject Scenario
				...
				//Create and  delete Tasks Scenario
